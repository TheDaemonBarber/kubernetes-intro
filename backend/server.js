...
app.get('/api/me', (request, response) => {
	response.send('{"name": "Zaphod Beeblebrox", "location": "Somewhere Cool"}');
	logger.info('Responded to GET request on /api/me')
});

app.get('/api/work', (request, response) => {
	response.send('[{"yearFrom": "1997", "yearTo": "2018", "place": "Insignificant blue/green dot", "comment": "Was doing cool stuff"}, {"yearFrom": "2009", "yearTo": "2010", "place": "The coffee shop", "comment": "Making coffee"}]');
